package org.example.homework_2024_02_29.task3;
...
//  Вскоре вводные данные поменялись и понадобилась траншея больше нашего забора, но меньше 5-метровой стены. Проверять докопал или нет по-прежнему надо, поскольку с глазомером у рабочего так себе...
...
//  Утомился наш чернорабочий и решил взять отгул, только никак не мог решить в какой день, пришлось бросать жребий.
